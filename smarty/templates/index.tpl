...
<body>
    <form  method="post" accept-charset="utf-8">
        ...
        <div>
            ...
            <input type="text" maxlength="40" value="{$name.seller_name|default:''}" name="seller_name" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" maxlength="50" value="{$name.title|default:''}" name="title" required> 
        </div>
        <div>
